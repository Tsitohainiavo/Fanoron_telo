...
class FanoronteloView(arcade.View):
    ...
    def on_mouse_press(self, x, y, button, modifiers):
     ...
     # Vérifier le clic sur le bouton undo
        ...
        if self.show_menu:
            ...
            # Si on clique ailleurs sur l'écran, fermer le menu
            self.show_menu = False
            return
    ...
    def draw_hud(self):
        ...
        arcade.draw_text("FANORONTELO", 24, h-46, (240,220,170), 24, bold=True)
        ...
        arcade.draw_text("M : Menu skin", w-100, h-46, (170,170,185), 13, anchor_x="right")
...
class MenuButton:
    """Bouton flottant 'SKIN' pour ouvrir le menu de personnalisation."""
    ...
    def draw(self, active=False):
        ...
        # Icône palette (3 petits cercles colorés)
        dot_y = self.y + 3
        arcade.draw_circle_filled(self.x - 18, dot_y, 4, (224, 86,  86))
        arcade.draw_circle_filled(self.x - 8,  dot_y, 4, (218, 165, 32))
        arcade.draw_circle_filled(self.x + 2,  dot_y, 4, (70, 150, 235))

        # Texte
        arcade.draw_text("SKIN", self.x + 6, self.y - 6, fg, 12,
...
class FanoronteloView(arcade.View):
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        # Bouton Menu Skin — priorité absolue (fonctionne même si menu ouvert)
        ...
        # Gestion du menu
        if self.show_menu:
            # Géométrie EXACTE du menu (identique à draw_menu) afin que les
            # zones cliquables correspondent toujours à ce qui est affiché,
            # quelle que soit la taille réelle de la fenêtre.
            w = self.window.width
            h = self.window.height
            ...
            # --- Boutons de skin (même calcul de position que draw_menu) ---
            row_y = menu_y + menu_h - 70
            for skin in PieceSkin:
                if (menu_x + 20 < x < menu_x + menu_w - 20 and
                        row_y - 16 < y < row_y + 16):
                    self.current_skin = skin
                    return
                row_y -= 45

            # --- Boutons de palette (suite de la même colonne y) ---
            row_y -= 30  # espace pour le titre "PALETTES DE COULEURS"
            ...
            # --- Clic à l'intérieur du menu mais hors de tout bouton ---
            # On ne fait rien : le menu reste ouvert. Il ne se ferme que via
            # la croix, la touche ÉCHAP, ou le bouton SKIN. La fenêtre du
            # jeu, elle, n'est jamais affectée par un clic dans ce menu.
            if (menu_x < x < menu_x + menu_w and menu_y < y < menu_y + menu_h):
                return

            # --- Clic en dehors du cadre du menu : on referme juste le menu ---
            self.show_menu = False
            return
    ...
    def on_key_press(self, key, modifiers):
        if key == arcade.key.R:
            ...
            # Fermer le menu si ouvert, sinon ne rien faire
            if self.show_menu:
                self.show_menu = False
    ...
    def on_draw(self):
        ...
        # Bouton Menu Skin (toujours visible)
    ...
    def draw_piece(self, x, y, player, selected=False, node_id=None, alpha_factor=1.0):
        ...
        # Dessiner l'ombre adaptée à la forme
    ...
    def draw_piece_shadow(self, x, y, radius, alpha_factor=1.0):
        """Dessine l'ombre adaptée à la forme du skin."""
    ...
    def draw_hud(self):
        ...
        arcade.draw_lrbt_rectangle_filled(0, w, 0, 40, (12,14,22,230))
        arcade.draw_text(
            "Clic : sélectionner / déplacer   |   R : recommencer   |   Bouton SKIN : personnaliser",
            24, 12, (170,170,185), 13
        )
    ...
    def draw_menu(self):
        ...
        arcade.draw_lrbt_rectangle_outline(
            close_x - 15, close_x + 15, close_y - 15, close_y + 15,
            (100, 100, 120), 2
        )
        ...
        for skin in PieceSkin:
            ...
            if is_selected:
                arcade.draw_lrbt_rectangle_outline(
                    menu_x + 20, menu_x + menu_w - 20, y - 16, y + 16,
                    (240, 220, 170), 2
                )
        ...
        # Instructions
        arcade.draw_text(
            "Cliquez sur un skin pour changer vos pions",
            w//2, menu_y+20, (130, 130, 150), 13, anchor_x="center"
        )
